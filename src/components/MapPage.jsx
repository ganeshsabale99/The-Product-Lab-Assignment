...
function MapPage() {
  ...
  useEffect(() => {
    ...
    map.on("click", async (e) => {
      ...
      if (!activeField) {
        alert(
          "Please select a field (start or end) before clicking on the map."
        );
        return;
      }
      ...
      <div className="controls-panel">
        ...
        <div className="input-section">
          <div className="location-group">
            ...
            <div className="input-row">
              ...
              <button
                className={`action-btn map-select ${
          ...
          <div className="location-group">
            <label className="location-label">End Location</label>
            <div className="input-row">
              <input
                type="text"
                value={endInput}
        ...
        {routeDetails && (
          <div className="route-info">
            <h3 className="route-info-title">Map route details</h3>
